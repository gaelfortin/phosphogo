...
```{r}
# Import kinase predictions
enrichment <- read_csv('myexperiment/kinase_enrichment_networkin.csv')
deregulated_kinases<- enrichment %>% #select only deregulated kinases
