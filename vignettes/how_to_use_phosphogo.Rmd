...
You can also use the web interface of pĥosphogo with `r launchApp()`.
...
0. Install NetworKIN and IV-KEA
```{r eval=FALSE}
...
8. Compare enrichment tests from NetworKIN and IV-KEA
```{r}
